...
function getMobileHotspotFontSize(pixelRadius) {
  return Math.max(8, Math.min(16, pixelRadius * 0.7));
}
              ...
              if (isMobile) {
                return (
                  <button
                    ...
                    className="absolute flex items-center justify-center bg-white text-black rounded-full border-2 border-black shadow-lg hover:brightness-95 hover:scale-110 transition-all cursor-pointer font-bold leading-none"
                    style={{
                      ...
                      fontSize: `${getMobileHotspotFontSize(pixelRadius)}px`,
